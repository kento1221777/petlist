		...
		<div class="row petimagelist">
			<c:forEach items="${categoryTypeList}" var="category">
				<div class="col-md-3 col-sm-4 col-xs-6">
					...
					<a href="${uploads}/<c:out value="${category.image}" />" data-lightbox="group">
					<img class="img-thumbnail" src="${uploads}/<c:out value="${category.image}" />" width="300">
					</a>
